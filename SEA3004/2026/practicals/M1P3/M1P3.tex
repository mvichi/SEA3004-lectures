...
\begin{document}
\title{SEA3004F M1P3: Properties of the atmosphere}
...
\begin{enumerate}
\item Create a folder M1P3 on the computer
\item Download the scripts in that directory. (make sure they are moved
to the M1P3 directory)
\item Launch the software and change folder to M1P3 as done for the previous
practical
\end{enumerate}
...
Submit the livescript named \texttt{M1P3\_STUDENT\_NUMBER.mlx} containing
