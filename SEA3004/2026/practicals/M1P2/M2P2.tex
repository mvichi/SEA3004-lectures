...
\begin{document}
\title{SEA3004F M1P2: TEOS10}
\date{Module 1}
\maketitle

\section{Installing the GSW Oceanographic Toolbox}

The GSW (Gibbs SeaWater) Oceanographic Toolbox is a MATLAB toolbox that
contains the TEOS-10 subroutines for evaluating the thermodynamic properties of pure water and seawater. 
\begin{itemize}
\item Step 1 Create a folder M1P2 and download the GSW Oceanographic Toolbox
...
\item Step 3 (within MATLAB) Add the \textquotedblleft GSW\textquotedblright{}
...
Download the file TEOS10\_data.mat to your M1P2 directory. From this
...
pressures
\end{enumerate}
Submit your Live Script file, named \texttt{M1P2\_STUDENTNUMBER.mxl}.
\end{document}
